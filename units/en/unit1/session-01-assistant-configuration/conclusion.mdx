...
You wrote the acceptance checks into the file itself: `uv run pytest -q` and `uv run ruff check .` decide done, and the assistant never claims a command ran unless it ran.
