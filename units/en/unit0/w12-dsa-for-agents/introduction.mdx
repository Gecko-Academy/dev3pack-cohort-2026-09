...
<!-- navigation:start -->
[Previous: Databases, APIs, and third-party servers](../w11-mcp-data-apis-third-party/introduction.mdx) · Next: Configure the assistant and the repository instructions — opens Mon 14 Sep
<!-- navigation:end -->
