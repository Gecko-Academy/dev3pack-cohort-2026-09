...
|---:|---|---|---|
| [11](../session-11-state-and-memory/introduction.mdx) | Mon 28 Sep | State and memory | scored |
| [12](../session-12-mcp-architecture/introduction.mdx) | Tue 29 Sep | MCP architecture and primitives | scored |
| [13](../session-13-secure-mcp-server/introduction.mdx) | Wed 30 Sep | Build and secure an MCP server | scored |
| [14](../session-14-deploy-and-operate/introduction.mdx) | Thu 01 Oct | Deploy and operate the capstone | scored |
| [15](../session-15-defend-the-capstone/introduction.mdx) | Fri 02 Oct | Defend the capstone | no notebook |
