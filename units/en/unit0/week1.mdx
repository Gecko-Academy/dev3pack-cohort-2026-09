...
|---:|---|---|---|
| [1](../session-01-assistant-configuration/introduction.mdx) | Mon 14 Sep | Configure the assistant and the repository instructions | handed in |
| [2](../session-02-model-adapter/introduction.mdx) | Tue 15 Sep | Call a model through the adapter | scored |
| [3](../session-03-structured-outputs/introduction.mdx) | Wed 16 Sep | Structured outputs | scored |
| [4](../session-04-bounded-tools/introduction.mdx) | Thu 17 Sep | Bounded tools | scored |
| [5](../session-05-deterministic-mini-agent/introduction.mdx) | Fri 18 Sep | A deterministic mini-agent | scored |
