...
|---:|---|---|---|
| 1 — not yet | Mon 14 Sep | Configure the assistant and the repository instructions | handed in |
| 2 — not yet | Tue 15 Sep | Call a model through the adapter | scored |
| 3 — not yet | Wed 16 Sep | Structured outputs | scored |
| 4 — not yet | Thu 17 Sep | Bounded tools | scored |
| 5 — not yet | Fri 18 Sep | A deterministic mini-agent | scored |
