...
| **The private grader and the certificate** | The same grader on a private set: same shape, unseen questions | The course app. The answer keys never leave it. | The course | That your agent works on questions it was never tuned on. A pass gets a certificate signed with Ed25519, which anyone can verify. | At the end. It needs the 30% bar **and** every critical case. |
...
| **The certificate** | The private grader: the 30% bar **and** every critical question | The credential, signed, that anyone can verify |
...
Also good: a "Sources" line from session 13, and the rollback sentence from
session 14.
...
| Another student's answers or code | It is their work, and your showcase is a claim about yours. |
